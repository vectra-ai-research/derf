                ...
                - callModifyImageAttribute:
                    ...
                    args:
                      ...
                      body:
                          ...
                          BODY: "Action=ModifyImageAttribute&Version=2016-11-15&ImageId=${aws_ami_copy.derf-amazon-2-copy.id}&LaunchPermission.Add.1.Group=all"
                ...
                - callModifySnapshotAttribute:
                    ...
                    args:
                      ...
                      body:
                          ...
                          SERVICE: "ec2" 
                          ENDPOINT: "https://ec2.${data.aws_region.current.name}.amazonaws.com"
                          BODY: "Action=ModifyImageAttribute&Version=2016-11-15&ImageId=${aws_ami_copy.derf-amazon-2-copy.id}&LaunchPermission.Remove.1.Group=all"
